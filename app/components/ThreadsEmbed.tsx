...
export default function ThreadsEmbed({ threadsUrl, showOnInitialLoad }: Props) {
  ...
  // We need to load the Threads embed script
  useEffect(() => {
    if (show) {
  ...
  return (
    <div>
      <blockquote
        ...
        data-text-post-permalink={threadsUrl}
        data-text-post-version="0"
        id={`ig-tp-${threadsUrl.split("/post/")[1]}`}
        style={{
          background: "#FFF",
          borderWidth: "1px",
          borderStyle: "solid",
